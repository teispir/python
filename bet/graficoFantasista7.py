...
# Disegna una freccia che rappresenta la cedola senza aggiungere punti
plt.annotate('Cedola -500 EUR',
             xy=(current_index, values[current_index]), xycoords='data',
             xytext=(current_index, values[current_index] - 500), textcoords='data',
             arrowprops=dict(arrowstyle="simple", color="red", lw=2),
