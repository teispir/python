...
current_index = len(values) - 1  # Nuovo ultimo valore (dopo cedola)
pre_cedola_index = current_index - 1  # Punto prima della cedola (1756.33)
...
highlight_indices = [min_index, max_index, pre_cedola_index]
highlight_values = [values[min_index], values[max_index], values[pre_cedola_index]]
colors = ['red', 'green', 'purple']
labels = ['Min', 'Max', 'Pre-Cedola']
