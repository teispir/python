# Aggiorniamo lo script per supportare qualsiasi importo di puntata
...
# Salviamo il nuovo script nel file aggiornato
file_path_updated = "/mnt/data/calcolatore_bonus_snai_aggiornato.py"
